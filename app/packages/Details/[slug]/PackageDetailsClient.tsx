            ...
            {selectedTier?.inclusions?.length ? (
              <div className="rounded-2xl border border-border bg-card p-5 md:p-6 shadow-card">
                ...
                <ul className="mt-4 grid sm:grid-cols-2 gap-3">
                  {selectedTier.inclusions.filter(Boolean).map((highlight, index) => (
                    <li key={`${highlight}-${index}`} className="flex gap-3 rounded-xl bg-secondary/50 p-4">
          ...
          <aside className="lg:sticky lg:top-24">
            <div className="rounded-3xl border border-border bg-card p-5 md:p-6 shadow-card">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Switch between available package options for this service.
              </p>
