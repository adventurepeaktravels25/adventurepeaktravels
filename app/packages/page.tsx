...
export default async function PackagesPage() {
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-3 sm:px-6 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 md:gap-6">
      ...
      <div className="p-2.5 sm:p-5 flex flex-col flex-1">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            {tier && <span className="mt-1 inline-flex w-fit items-center gap-1 whitespace-nowrap rounded-full bg-gradient-sunset text-accent-foreground text-[9px] sm:text-xs font-bold px-2.5 py-1 shadow-soft leading-none">{tier.duration ?? tier.type ?? "Package"}</span>}
          </div>
        </div>
