            ...
            {results.map((a) => (
              <li key={a.code}>
                ...
                >
                  ...
                  <span className="text-xs font-bold tracking-wider rounded bg-secondary px-2 py-1">
                    {a.code}
                  </span>
                </button>
              </li>
...
export function FlightBookingWidget() {
  ...
  return (
    <form
      onSubmit={submit}
      className="rounded-2xl bg-card text-card-foreground p-4 sm:p-5 shadow-soft border border-border"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
        ...
        <div className="md:col-span-2 flex md:justify-center">
          <button
            type="button"
            onClick={swap}
            className="h-10 w-10 rounded-full border border-border bg-background hover:bg-secondary flex items-center justify-center"
            aria-label="Swap"
          >
        ...
        <div className="md:col-span-4">
          ...
          <div className="relative mt-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-input bg-background pl-9 pr-3 py-2.5 text-sm disabled:opacity-50"
            />
          </div>
        </div>
        <div className="md:col-span-12 relative" ref={paxRef}>
          <label className="block text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
            Passengers
          </label>
          <button
            ...
            className="mt-1 w-full rounded-lg border border-input bg-background pl-9 pr-3 py-2.5 text-sm text-left relative"
          >
                ...
                <div key={row.label} className="flex items-center justify-between gap-3">
                  ...
                  <div className="inline-flex items-center gap-2">
                    <button
                      ...
                      className="h-7 w-7 rounded-full border border-border hover:bg-secondary disabled:opacity-40"
      ...
      <button
        type="submit"
        className="mt-5 w-full rounded-xl bg-gradient-sunset text-accent-foreground py-3 font-semibold shadow-soft inline-flex items-center justify-center gap-2"
      >
